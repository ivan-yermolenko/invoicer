...
<template>
  <div v-if="meta && meta.last_page > 1" class="px-6 py-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
    <button 
    ...
    <span class="text-sm text-slate-600">
      Сторінка <span class="font-medium text-slate-900">{{ meta.current_page }}</span> з <span class="font-medium text-slate-900">{{ meta.last_page }}</span>
    </span>
