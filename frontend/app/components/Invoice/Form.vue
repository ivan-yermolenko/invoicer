    ...
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <div v-if="isReadonly" class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-700 opacity-75 cursor-not-allowed">
          ...
          <input
            ...
            v-model="issueDate"
            type="date"
            class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
